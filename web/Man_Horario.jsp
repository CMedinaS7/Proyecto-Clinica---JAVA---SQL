      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Mantenimiento del Horario</td>
                </tr>
              </tbody>
            </table>
            ...
            <tr>
                <td height="553"><form action="ModifyHorario" method="get">
                <center><fieldset style=" background-color:#CCCCCC; width:380px;">
<div align="left">

  
    <div align="center">
    <span class="maternidad_txt_destacado">Ingrese Nombre:      </span><span class="maternidad_txt_destacado">
    <%         
    if ("3".equals(resp)) {
    %>
...
<table width="365" align="center" background="imagenes/fondo_hor.png">
<tr>
  <td width="39" class="vacunatorio_titulo_n2">&nbsp;</td>
                      <td width="103" class="vacunatorio_titulo_n2">&nbsp;</td>
                      <td width="191">&nbsp;</td>
                      <td width="12">&nbsp;</td>
</tr>
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                                <td class="vacunatorio_titulo_n2">Turno:</td>
                                <td><%         
    if ("3".equals(resp)) {
    %>
                                  <input type="text" name="txtnombre" value="<%=request.getParameter("turno")%>" size="25"  onkeyup="this.value = this.value.replace (/[^aA-zZ]/,'');" />
                                  <% } else { %>
                                  <input name="txtnombre" type="text" id="txtnombre"  onkeyup="this.value = this.value.replace (/[^aA-zZ]/,'');" size="25" />
                                  <% } %>
                              <br /></td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                                <td class="vacunatorio_titulo_n2">Hora Entrada:</td>
                                <td><%         
    if ("3".equals(resp)) {
    %>
                                  <input name="txthorae" type="text" id="txthorae" value="<%=request.getParameter("horae")%>" />
                                  <% } else { %>
                                  <input name="txthorae" type="text" id="txthorae" />
                              <% } %>                                  <br /></td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                                <td class="vacunatorio_titulo_n2">Hora Salida:</td>
                                <td><%         
    if ("3".equals(resp)) {
    %>
                                  <input name="txthoras" type="text" id="txthoras" value="<%=request.getParameter("horas")%>" />
                                  <% } else { %>
                                  <input name="txthoras" type="text" id="txthoras" />
                              <% } %><br /></td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="34" class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                            </tr>
 ...
 <% String msg=request.getParameter("msg");
                      ...
                      %>
                       ...
                       <% }} %>
                        ...
                        %>
                        <script language='javaScript' >
                            alert("Error al Modificar Horario!");
                        </script>
                      	<% } %>
