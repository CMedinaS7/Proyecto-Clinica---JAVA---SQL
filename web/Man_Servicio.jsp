      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Mantenimiento de los Servicios</td>
                </tr>
              </tbody>
            </table>
            ...
            <tr>
              <td height="553"><form action="ModifyServicio" method="post">
                <center><fieldset style=" background-color:#CCCCCC; width:380px;">
<div align="left">
  <legend></legend>
  
    <div align="center">
      <legend><span class="maternidad_txt_destacado">Ingrese Nombre: 
...
<table width="366" align="center" background="imagenes/fondo_ser.png">
  <tr>
    <td width="34" class="vacunatorio_titulo_n2">&nbsp;</td>
    <td width="82" class="vacunatorio_titulo_n2">&nbsp;</td>
    <td width="218">&nbsp;</td>
    <td width="12">&nbsp;</td>
  </tr>
  <tr>
    ...
    %>
      ...
      <input name="txtname" type="text" id="txtname"  onkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');" value="<%=request.getParameter("nombre")%>" size="25" />
      <span class="maternidad_txt_destacado">
      <% } else { %>
      </span>
      <input name="txtname" type="text" id="txtname"  onkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');" size="25" />
      <span class="maternidad_txt_destacado">
      <% } %>
      </span><br /></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td class="vacunatorio_titulo_n2">&nbsp;</td>
    <td class="vacunatorio_titulo_n2">Precio:</td>
    <td><span class="maternidad_txt_destacado">
      <%         
    if ("3".equals(resp)) {
    %>
  ...
  <tr>
    <td height="40" class="vacunatorio_titulo_n2">&nbsp;</td>
    <td class="vacunatorio_titulo_n2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
      ...
      <input name="Restablecer" type="reset" class="boton"  value="Cancelar"  border="2"/>
             ...
             <% String msg=request.getParameter("msg");
                        ...
                        <script language='javaScript' >
                            alert("Servivio registrado correctamente!");
                        </script>
                      <% }else{
                            if(msg=="No"){
                      %>
