<%
			...
			String Especialista = (String) sesion.getAttribute("apellido");
...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.*, Beans.paciente"%>
...
<!-- 
 function PopWindow()
{
window.open('HistorialMedico.jsp?codigo=<%=cod%>&nombre=<%=nombres%>&apepaterno=<%=apepaterno%>&apematerno=<%=apematerno%>&foto=<%=imagen%>&usu=<%=Especialista%>','360','width=550,height=700,menubar=no,scrollbars=no,toolbar=no,location=no,directories=no,resizable=no,top=0,left=0');
}
//-->
</script>
<%
      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Mantenimiento del Paciente</td>
                </tr>
              </tbody>
            </table>
            ...
            <tr>
                <td height="553"><form action="ModifyPaciente" method="post" name="pacientes">
                <center><fieldset style=" background-color:#CCCCCC; width:380px;">
<div align="left">
  <legend></legend>
  
    <div align="center">
      <legend><span class="maternidad_txt_destacado">Ingrese Apellido o Codigo: 
    ...
    %>
      ...
      <input type="submit" class="boton"  value="Buscar"  name="buscar" border="2"/>
                ...
                <table width="387" height="406" align="center" background="imagenes/fondo_pac.png">
                            <tr>
                              <td width="21" class="vacunatorio_titulo_n2">&nbsp;</td>
    ...
    %>
                                ...
                                <input name="txtapepaterno" type="text" id="txtapepaterno" onkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');" value="<%=request.getParameter("apepat")%>" size="25" />
    ...
    %>
                                ...
                                <input name="txtapematerno" type="text" id="txtapematerno" onkeyup="this.value = this.value.replace (/[^aA-zZ]/,'');" value="<%=request.getParameter("apemat")%>" size="25" />
                                <span class="maternidad_txt_destacado">
                                <% } else { %>
    ...
    %>
                              ...
                              <input type="text" name="txtnombre" value="<%=request.getParameter("nombres")%>" size="25"  onkeyup="this.value = this.value.replace (/[^aA-zZ]/,'');" />
                              <span class="maternidad_txt_destacado">
                              <% } else { %>
                              </span>                                  <input name="txtnombre" type="text" id="txtnombre"  oonkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');" value="" size="25" />
                              <span class="maternidad_txt_destacado">
                              <% } %>
                              </span><br /></td>
                              <td>&nbsp;</td>
    ...
    %>
                              ...
                              <input type="text" name="txtfechanac" value="<%=request.getParameter("fechanac")%>" readonly="readonly" /><span class="maternidad_txt_destacado">
                               <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'pacientes',
		...
		'controlname': 'txtfechanac'
                                  ...
                                  <input name="txtfechanac" type="text" id="txtfechanac" readonly="readonly" />
                                  <span class="maternidad_txt_destacado">
                                  <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'pacientes',
    ...
    %>
                              ...
                              <input name="txtlugarnac" type="text" onkeyup="this.value = this.value.replace (/[^aA-zZ]/,'');" value="<%=request.getParameter("lugarnac")%>" size="20" />
                                  <span class="maternidad_txt_destacado">
                                  <% } else { %>
                              </span>
                                  <input name="txtlugarnac" type="text" id="txtlugarnac" onkeyup="this.value = this.value.replace (/[^aA-zZ]/,'');" size="20" />
                                  <span class="maternidad_txt_destacado">
                                  <% } %>
                              </span><br /></td>
                              <td>&nbsp;</td>
    ...
    %>
                                  ...
                                  <input name="txtdireccion" type="text" id="txtdireccion" style="width:200px;" value="<%=request.getParameter("direccion")%>" size="25" />
                                  <span class="maternidad_txt_destacado">
                                  <% } else { %>
                                  </span>
                                  <input name="txtdireccion" type="text" id="txtdireccion" style="width:200px;" size="25" />
                                  <span class="maternidad_txt_destacado">
                                  <% } %>
                                </span><br /></td>
                              <td>&nbsp;</td>
    ...
    %>
                                ...
                                <input name="txtemail" type="text" id="txtemail" style="width:200px;" value="<%=request.getParameter("email")%>" size="25" />
                                <span class="maternidad_txt_destacado">
                                <% } else { %>
                              </span>
                                <input name="txtemail" type="text" id="txtemail" style="width:200px;" size="25" />
                                <span class="maternidad_txt_destacado">
                                <% } %>
                              </span><br /></td>
                              <td>&nbsp;</td>
    ...
    %>
                              ...
                              <input type="text" name="txttelf" value="<%=request.getParameter("telefono")%>" size="10" maxlength="9"  onkeyup="this.value = this.value.replace (/[^0-9]/,'');"/>
                                  <span class="maternidad_txt_destacado">
                                  <% } else { %>
                              </span>
                                  <input name="txttelf" type="text" id="txttelf"  onkeyup="this.value = this.value.replace (/[^0-9]/,'');" size="10" maxlength="9"/>
                                  <span class="maternidad_txt_destacado">
                                  <% } %>
                              </span><br /></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="vacunatorio_titulo_n2">Fecha de Registro</td>
                              <td><span class="maternidad_txt_destacado">
                              <%         
    if ("3".equals(resp)) {
    %>
                              </span>
                            <input type="text" name="txtfechareg" value="<%=request.getParameter("fechareg")%>" readonly="readonly" /><span class="maternidad_txt_destacado"><script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'pacientes',
		...
		'controlname': 'txtfechareg'
                               ...
                               <span class="maternidad_txt_destacado">
                                  <input name="txtfechareg" type="text" id="txtfechareg" readonly="readonly" /><script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'pacientes',
    ...
    %>
                                  ...
                                  <input name="txtusuario" type="text" id="txtusuario" style="width:200px;" value="<%=request.getParameter("user")%>" size="25" />
                                  <span class="maternidad_txt_destacado">
                                  <% } else { %>
                                  </span>
                                  <input name="txtusuario" type="text" id="txtdireccion4" style="width:200px;" size="25" />
                                  <span class="maternidad_txt_destacado">
                                  <% } %>
                                </span><br /></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="vacunatorio_titulo_n2">Clave</td>
                              <td><span class="maternidad_txt_destacado">
                                <%         
    if ("3".equals(resp)) {
    %>
                                </span>
                                  <input name="txtclave" type="text" id="txtclave" style="width:200px;" value="<%=request.getParameter("clave")%>" size="25" />
                                  <span class="maternidad_txt_destacado">
                                  <% } else { %>
                                  </span>
                                  <input name="txtclave" type="text" id="txtdireccion6" style="width:200px;" size="25" />
                                  <span class="maternidad_txt_destacado">
                                  <% } %>
                                </span><br /></td>
                              <td>&nbsp;</td>
    ...
    %>
                              ...
                              <input type="text" name="txtobservacion" value="<%=request.getParameter("observacion")%>" style="width:200px;" />
                              <span class="maternidad_txt_destacado">
                              <% } else { %>
                              <input name="txtobservacion" type="text" id="txtobservacion" style="width:200px;" />
                              <% } %>
                              </span></td>
                              <td>&nbsp;</td>
                            </tr>
                ...
                <div align="center"><span class="maternidad_txt_destacado">
                  <%        
				   
    if ("3".equals(resp)) {
    %>
                  <a href="JavaScript:PopWindow()"><img src="imagenes/hismed.png" width="147" height="35" border="0" /></a>
                  <% } else { %>
                  <img src="imagenes/hismed.png" width="147" height="35" />
                  <% } %>
                  </span><br />
                  <br />
                </div>
