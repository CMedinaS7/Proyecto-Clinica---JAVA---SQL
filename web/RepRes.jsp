      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Reportes - Reserva</td>
                </tr>
              </tbody>
            </table>
...
<tr>
  <td colspan="3" class="vacunatorio_titulo_n2"><div align="center" class="vacunatorio_titulo_n2">REPORTES PARA MOSTRAR</div></td>
                      <td width="17">&nbsp;</td>
                            ...
                            <tr>
                              <td width="26" class="vacunatorio_titulo_n2">&nbsp;</td>
                                <td width="120" class="urologia_txt_destacado">Todas las Reservas:</td>
                                <td width="261"><label></label>
                                  <label></label>
                                  <form action="Report/ReservaTodas.jsp" method="post" name="form2" target="_blank" id="form2">
                            ...
                            <tr>
                              ...
                              <td><form action="Report/ReservasCod.jsp" method="post" name="form1" target="_blank" id="form1">
                                <label>
                            ...
                            <tr>
                              <td height="22" class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="vacunatorio_titulo_n2"><span class="urologia_txt_destacado">Ingrese Servicio:</span></td>
                              <td><form action="Report/ReservasCod.jsp" method="post" name="form1" target="_blank" id="form3">
                                  <label>
                                  <input type="text" name="codigo" id="codigo" />
                                  </label>
                                  <label>
                            ...
                            <tr>
                              <td height="22" class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="vacunatorio_titulo_n2"><span class="urologia_txt_destacado">Ingrese Especialidad:</span></td>
                              <td><form action="Report/ReservasCod.jsp" method="post" name="form1" target="_blank" id="form7">
                                  <label>
                                  <input type="text" name="codigo" id="codigo4" />
                                  </label>
                                  <label>
                                  <input type="submit" name="button4" id="button6" value="Buscar" />
                                  </label>
                                  <br />
                              </form></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="urologia_txt_destacado">Todas las Reservas:</td>
                              <td><label></label>
                                  <label></label>
                                  <form action="Report/ReservaTodas_1.jsp" method="post" name="form2" target="_blank" id="form4">
                                    <input type="submit" name="button3" id="button3" value="Mostrar" />
                                    <br />
                                </form></td>
                              <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                              <td height="21" colspan="4" class="textoGeneral"><div align="center" class="medicina_preventiva_noticia_texto"><strong>*Nota:</strong> Para imprimir los reportes es necesario tener el papel membretado, si no tiene uno haga <a href="membrete/membrete1.pdf" target="_blank"><strong>click aqui</strong></a></div></td>
                            </tr>
                        </table>
