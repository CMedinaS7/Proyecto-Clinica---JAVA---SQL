    ...
    <tbody>
      ...
      <tr>
        <td colspan="2"><table width="785" border="0" background="imagenes/f1.jpg">
          <tr>
            <td width="760"><span class="NClinks_titulo"><a href="Intranet.jsp"><strong>Home</strong></a><strong> | </strong><a href="consultas.jsp"><strong> Consultas</strong></a><strong> | </strong><a href="paginas/Index.html"><strong>Web Corporativa</strong></a><strong> |</strong></span></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
          ...
          <table width="559" height="268" border="0">
            <tr>
              <td height="23"><div align="center" class="tablaTitulo"><strong>REALIZE SU CONSULTA</strong></div></td>
            </tr>
            <tr>
              <td height="26" class="oncolinks"> <p>Estas condiciones de uso regulan la utilización de los contenidos de esta Intranet por parte de los trabajadores de la Clinica Salud medical. Esta Intranet puede ser visitada libremente por los trabajadores de esta Compañía para propósitos propios dentro del desempeño de sus funciones en el entorno laboral en esta Compañía. </p>
              </td>
            </tr>
            <tr>
              <td height="173"><p align="center" class="medicina_preventiva_titulo_n1">LOS SENTIMOS EL SERVICIO DE CONSULTAS VIA ON-LINE NO ESTA DISPONIBLE POR EL MOMENTO.</p>
              <p align="center" class="medicina_preventiva_titulo_n1">ESTAMOS TRABAJANDO PARA SERVIRLE MEJOR.</p>
              <p align="center" class="medicina_preventiva_titulo_n1"><img src="iconos/delete_page.png" width="128" height="128" /></p></td>
            </tr>
          </table>          
        </td>
        ...
        out.println("<center><font color=red >"+request.getParameter("error")+"</font></center>");
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody>
                ...
                <tr>
                  <td><div align="center"><a href="consultas.jsp" target="_self"><img src="imagenes/accesocv.jpg" border="0" /></a> </div></td>
                </tr>
                <tr>
