...
<div align="left">
  <legend></legend>
    ...
    if ("3".equals(resp)) {
    %>
      <input name="txtcodigo" type="text" style="width:200px;" value="<%=request.getParameter("codigo")%>" size="15" maxlength="15"/>
      <% } else { %>
      <input type="text" name="txtcodigo" size="15"/>
      <% } %>
...
<table width="337"align="center"  background="imagenes/fondo_res.png" class="vacunatorio_titulo_n2">
  <tr>
    <td width="10">&nbsp;</td>
    <td width="87">&nbsp;</td>
    <td width="7">&nbsp;</td>
  ...
  <tr>
    ...
    %>
      ...
      <input name="txtfecha" type="text" id="txtfecha" value="<%=request.getParameter("fecha")%>" readonly="readonly" /><span class="maternidad_txt_destacado">
    <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'reserva',
        ...
        <input name="txtfecha" type="text" id="txtfecha" readonly="readonly" /><span class="maternidad_txt_destacado">
          <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'reserva',
  ...
  <tr>
    ...
    %>
      ...
      <input name="reloj" type="text" value="<%=request.getParameter("hora")%>" size="10">  
      <span class="maternidad_txt_destacado">
      <% } else { %>
      </span>
      <input name="reloj" type="text" id="reloj" size="10" />
      <span class="maternidad_txt_destacado">
      <% } %>
      </span><br /></td>
  </tr>
