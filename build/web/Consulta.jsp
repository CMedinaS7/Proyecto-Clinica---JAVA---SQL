...
<table width="505" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      <td height="20" colspan="2" class="convescolar"><div align="center">Esta seccion es solo para el administrador. El administrador se compromete a no dañar ni modificar datos de la BD en beneficio propio.</div></td>
    </tr>
    <tr>
      <td height="20" colspan="2" class="convescolar"><form action="Resultado.jsp" method="post" name="form1" target="topFrame" id="form1">
        <label>
        <div align="center">
    ...
    <tr>
      <td height="20" colspan="2" class="convescolar"><div id="resultado"></div></td>
    </tr>
  </tbody>
</table>
<div align="center"></div>
