      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Reportes - Paciente</td>
                </tr>
              </tbody>
            </table>
            ...
            <tr>
                <td height="553"><table width="444" border="0" align="center" bordercolor="#003333" bgcolor="#CCCCCC">
<tr>
                      ...
                      <td width="17">&nbsp;</td>
                            ...
                            <tr>
                              <td width="32" class="vacunatorio_titulo_n2">&nbsp;</td>
                                <td width="114" class="urologia_txt_destacado">Pacientes Activos:</td>
                                <td width="261"><label></label>
                                  <label></label>
                                  <form action="Report/PacienteTodos.jsp" method="post" name="form2" target="_blank" id="form2">
                            ...
                            <tr>
                              ...
                              <td><form action="Report/PacienteApeCod.jsp" method="post" name="form1" target="_blank" id="form1">
                                <label>
                            ...
                            <tr>
                              <td height="22" class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="vacunatorio_titulo_n2"><span class="urologia_txt_destacado">Ingrese Apellido:</span></td>
                              <td><form action="Report/PacienteApeCod.jsp" method="post" name="form1" target="_blank" id="form3">
                                  <label>
                                  <input type="text" name="codigo" id="codigo" />
                                  </label>
                                  <label>
                            ...
                            <tr>
                              <td class="vacunatorio_titulo_n2">&nbsp;</td>
                              <td class="urologia_txt_destacado">Pacientes Activos:</td>
                              <td><label></label>
                                  <label></label>
                                  <form action="Report/PersonalTodos_1.jsp" method="post" name="form2" target="_blank" id="form6">
