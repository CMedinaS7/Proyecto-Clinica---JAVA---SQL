...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.*, Beans.especialidad" %>
      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Mantenimiento de la Especialidad</td>
                </tr>
              </tbody>
            </table>
            ...
            <tr>
              <td height="553"><form action="ModifyEspecialidad" method="post">
                <center><fieldset style=" background-color:#CCCCCC; width:380px;">
<div align="left">
  
  
    <div align="center">
      <span class="maternidad_txt_destacado">Ingrese Codigo: 
...
<table width="365" align="center" background="imagenes/fondo_car.png">
  <tr>
    <td width="34" class="vacunatorio_titulo_n2">&nbsp;</td>
    <td width="83" class="vacunatorio_titulo_n2">&nbsp;</td>
    <td width="220">&nbsp;</td>
    <td width="8">&nbsp;</td>
  </tr>
  <tr>
...
<center>
 ...
 <% String msg=request.getParameter("msg");
                        ...
                        <script language='javaScript' >
                            alert("Especialidad registrado correctamente!");
                        </script>
                      <% }else{
                            if(msg=="No"){
                      %>
                       ...
                       <% }} %>
                        ...
                        %>
                        <script language='javaScript' >
                            alert("Error al Modificar Especialidad!");
                        </script>
                      	<% } %>
