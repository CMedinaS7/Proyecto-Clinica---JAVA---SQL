<%@ page contentType="text/html; charset=utf-8" language="java" import=" Dao.conexion,java.sql.*"%>
        ...
        height="25" /></td>
          ...
          <tr>
                ...
                <tbody>
                  ...
                  align="center">
                    ...
                    <td valign="top" width="73%"><table border="0" cellspacing="0" cellpadding="0" width="500">
                        ...
                        width="5" height="1" /></td>
                            <td width="338"><table width="440" border="0" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <td bgcolor="#F5F5F5"><span class="Estilo3"></span></td>
                                  <td><span class="Estilo3"></span></td>
                                </tr>
                                <tr>
                                  <td width="18" bgcolor="#F5F5F5">&nbsp;</td>
                                  <td width="407" bgcolor="#F5F5F5" class="NCcapitular"><span class="tabla_exa_news">Especialidad: </span><%=request.		getParameter("especialidad")%> </td>
                                  <td width="15"><img src="imagenes/red1.jpg" alt="" width="15" height="25" /></td>
                                </tr>
                              </tbody>
                            </table>
                              <br /></td>
		    ...
		    cn = con.conectar();
                    ...
                    <table width="453" border="0" align="center" cellpadding="2" cellspacing="0" class="textoGeneral">
                          <tbody>
                            <tr bgcolor="#425454">
                              <td width="82" bgcolor="#F5F5F5" class="NCcapitular" style="border-bottom:solid 1px #cccccc; padding-left: 10px"><div align="center">Codigo:</div></td>
                              <td width="93" height="23" bgcolor="#F5F5F5" class="NCcapitular" style="border-bottom:solid 1px #cccccc; padding-left: 10px"><div align="center">Apellidos</div></td>
                              <td width="84" height="18" bgcolor="#F5F5F5" class="NCcapitular" style="border-bottom:solid 1px #cccccc"><div align="center">Nombre</div></td>
                              <td width="99" bgcolor="#F5F5F5" class="NCcapitular" style="border-bottom:solid 1px #cccccc"><div align="center">Telefono</div></td>
                              <td width="75" height="18" bgcolor="#F5F5F5" class="NCcapitular" style="border-bottom:solid 1px #cccccc"><div align="center">Agenda</div></td>
                            </tr>
                            <tr>
                              <td colspan="8"><img src="./Cl&iacute;nica Santa Mar&iacute;a_files/1x1(2).gif" width="1" height="10" /></td>
                            </tr>
                            <tr class="textoGeneral">
                              <td width="82"><div align="center"><%=request.getParameter("codigo")%></div></td>
                              <td width="93"><div align="left" class="Estilo2">
                                <div align="center"><%=request.getParameter("apellidos")%></div>
                              </div></td>
                              <td width="84"><div align="center"><span class="Estilo2"><%=request.getParameter("nombre")%></span></div></td>
                              <td width="99" align="center" bgcolor="#ffffff"><div align="center"><span class="Estilo2"><%=request.getParameter("telefono")%></span></div></td>
                              <td width="75" align="center" bgcolor="#ffffff"><div align="center">
                                <form id="form1" name="form1" method="post" action="MostrarEspecialista2">
                                  <label>
                                    <input type="hidden" name="codigo" value="<%=request.getParameter("codigo")%>"/>
                                    <input type="image"  style="border:0" name="imageField" id="imageField" src="imagenes/ver_boton.gif" />
                                  </label>
                                </form>
                                </div></td>
                            </tr>
                        ...
                        <table width="50" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tbody>
                            <tr>
                              <td width="30"><a href="Reserva01.jsp"><img src="imagenes/volver.jpg" width="30" height="30" border="0" alt="Volver" /></a></td>
                              <td><a href="Reserva01.jsp">Volver</a></td>
                            </tr>
                          </tbody>
                      </table>                        <p align="center">&nbsp;</p>
                      <p align="center"><img src="imagenes/header_medico.jpg" width="500" height="120" /></p></td>
                  </tr>
                  <tr>
