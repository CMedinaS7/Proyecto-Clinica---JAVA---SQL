...
<div id="contenido">
  <table width="761" border="0" align="center" cellpadding="0" cellspacing="0" class="alinea">
      ...
      <tr>
        <td width="565" valign="top"><script src="js/AC_RunActiveContent.js" type="text/javascript"></script>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla-home">
              <tbody>
                <tr>
                  <td valign="top" class="busqTitulo">Mantenimiento del Personal</td>
                </tr>
              </tbody>
            </table>
            ...
            <table width="586" height="559" bgcolor="#EBEBEB">
              <tr>
                <td height="553"><form action="ModifyPersonal" method="post" name="personal">
                    <center>
                      <fieldset style=" background-color:#CCCCCC; width:380px;">
                      <div align="left">
                        <legend></legend>
                        <div align="center">
                          <legend><span class="maternidad_txt_destacado">Ingrese Apellido o Codigo: </span><span class="maternidad_txt_destacado">
                          <%         
    if ("3".equals(resp)) {
    %>
                  ...
                  <table width="415" height="424" align="center" background="imagenes/fondo_per.png">
                      <tr>
                        <td width="41" class="vacunatorio_titulo_n2">&nbsp;</td>
                        <td width="134" class="vacunatorio_titulo_n2">&nbsp;</td>
                        <td width="202">&nbsp;</td>
                        <td width="18">&nbsp;</td>
                      </tr>
                      <tr>
    ...
    %>
                        ...
                        <input name="txtapellidos" type="text" id="txtapellidos" size="25" onkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');"/>
                        </span><span class="maternidad_txt_destacado">
                        <% } %>
                        </span><br /></td>
                        <td>&nbsp;</td>
    ...
    %>
                        ...
                        <input type="text" name="txtnombre" value="<%=request.getParameter("nombres")%>" size="25"  onkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');" />
                            <span class="maternidad_txt_destacado">
                            <% } else { %>
                        </span>
                            <input name="txtnombre" type="text" id="txtnombre"  onkeyup="this.value = this.value.replace (/[^A-ZÑa-zñ 32]/, '');" size="25" />
                            <span class="maternidad_txt_destacado">
                            <% } %>
                        </span><br /></td>
                        <td>&nbsp;</td>
...
<input name="txtdni" type="text" id="txtdni"  onkeyup="this.value = this.value.replace (/[^0-9]/,'');" value="<%=request.getParameter("dni")%>" size="10" maxlength="8"/>
    ...
    %>
                        ...
                        <input name="txtfechanac" type="text" id="txtfechanac" value="<%=request.getParameter("fechanac")%>" readonly="readonly" /><span class="maternidad_txt_destacado">
                        <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'personal',
		...
		'controlname': 'txtfechanac'
                                            ...
                                            <span class="maternidad_txt_destacado">
		                      <% } else { %><input name="txtfechanac" type="text" id="txtfechanac" readonly="readonly" /><span class="maternidad_txt_destacado">
    ...
    %>
                          ...
                          <input type="text" name="txtdireccion" value="<%=request.getParameter("direccion")%>" size="25" style="width:200px;" />
                            <span class="maternidad_txt_destacado">
                            <% } else { %>
                            </span>
    ...
    %>
                          ...
                          <input type="text" name="txtfechareg" value="<%=request.getParameter("fechareg")%>" readonly="readonly" /><span class="maternidad_txt_destacado">
                             <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'personal',
		...
		'controlname': 'txtfechareg'
                          ...
                          <input name="txtfechareg" type="text" id="txtfechareg" readonly="readonly" /><span class="maternidad_txt_destacado">
                           <script language="JavaScript" type="text/javascript">
		new tcal ({
		'formname': 'personal',
      ...
      <td>   <select name="cbocargo" id="cbocargo">
                                              <%
          ...
          <%
                      ...
                      <tr>
                        ...
                        <td><select name="cboturno" id="cboturno">
                          <%
